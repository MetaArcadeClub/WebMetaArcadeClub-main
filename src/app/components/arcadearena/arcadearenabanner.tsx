...
import slider_bg from '@/assets/img/bg/team_bg.jpg';
import slider_img from '@/assets/img/others/ArcadeArena.png';
                            ...
                            <div className="row justify-content-between">
                                <div className="col-lg-6">
                                    <div className="slider__content">
                                        <h6 className="sub-title wow fadeInUp" data-wow-delay=".2s">JOIN THE GRID!</h6>
                                        <h2 className="title wow fadeInUp" data-wow-delay=".5s">PLAY PIT</h2>
                                        <p className="wow fadeInUp" data-wow-delay=".8s">Arcade Arena</p>
                                        <div className="slider__btn wow fadeInUp" data-wow-delay="1.2s">
                                            <Link href="/arcade-arena" className="tg-btn-1"><span>battle now</span></Link>
                                        </div>
                                    </div>
                                </div>
