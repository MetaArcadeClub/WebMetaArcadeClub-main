...
class Particle {
    ...
    display() {
        this.p.stroke(68, 214, 44, this.alpha);  // RGB values for neon green
        this.p.strokeWeight(2);
        this.p.fill(68, 214, 44, this.alpha);  // RGB values for neon green
...
const M2ESketch = (props: { haloBackgroundRef: any }) => {
